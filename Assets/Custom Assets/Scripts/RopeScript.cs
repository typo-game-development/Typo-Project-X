...
public class RopeScript : MonoBehaviour
{
	...
	*/
    ...
    public Vector3 ropeColRadius = new Vector3(0.5F, 0.5F, 0.5F);                  //  Sets the radius of the collider in the SphereCollider component
    ...
    void AddJointPhysics(int n)
    {
        ...
        BoxCollider col = joints[n].AddComponent<BoxCollider>();
