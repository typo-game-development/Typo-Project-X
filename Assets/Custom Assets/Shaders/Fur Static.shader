Shader "Custom Shader/Fur Static" {
Properties {
...
{
	float2 uv = TRANSFORM_TEX(v.texcoord.xy, _ParallaxMap);
	float d = tex2Dlod(_ParallaxMap, float4(uv,0,0)).a * _Parallax;
