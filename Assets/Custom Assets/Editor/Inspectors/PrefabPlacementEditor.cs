...
public class PrefabPlacementEditor : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        prefabTag.stringValue = EditorGUILayout.TagField(new GUIContent("Remove Prefab Tag"), prefabTag.stringValue);
    ...
    public void MousePosition ()
    {
        ...
        if (Physics.Raycast(ray.origin, ray.direction, out hit, Mathf.Infinity, 1 << layerMask.intValue))
        {
            ...
            Handles.DrawSolidDisc(hit.point, hit.normal, radius.floatValue / 2 - 0.1f);
            Handles.color = Color.blue;
